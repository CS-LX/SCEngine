...
namespace FastColoredTextBoxNS {
    public class DarkSyntaxHighlighter : SyntaxHighlighter {
        //styles
        ...
        public DarkSyntaxHighlighter(FastColoredTextBox currentTb) : base(currentTb) {
        ...
        /// </summary>
        public new virtual void HighlightSyntax(string XMLdescriptionFile, Range range) {
        ...
        public new virtual void AutoIndentNeeded(object sender, AutoIndentEventArgs args) {
        ...
        protected new void PHPAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            /*
        ...
        protected new void SQLAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            var tb = sender as FastColoredTextBox;
            tb.CalcAutoIndentShiftByCodeFolding(sender, args);
        }

        protected new void HTMLAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            var tb = sender as FastColoredTextBox;
            tb.CalcAutoIndentShiftByCodeFolding(sender, args);
        }

        protected new void XMLAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            var tb = sender as FastColoredTextBox;
            tb.CalcAutoIndentShiftByCodeFolding(sender, args);
        }

        protected new void VBAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            //end of block
        ...
        protected new void CSharpAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            //block {}
            if (Regex.IsMatch(args.LineText, @"^[^""']*\{.*\}[^""']*$"))
                return;
            //start of block {}
        ...
        public new virtual void AddXmlDescription(string descriptionFileName, XmlDocument doc) {
        ...
        public new virtual void AddResilientStyle(Style style) {
            if (resilientStyles.Contains(style)) return;
            currentTb.CheckStylesBufferSize(); // Prevent buffer overflow
            resilientStyles.Add(style);
        }

        public new static SyntaxDescriptor ParseXmlDescription(XmlDocument doc) {
        ...
        protected new static FoldingDesc ParseFolding(XmlNode foldingNode) {
        ...
        protected new static RuleDesc ParseRule(XmlNode ruleNode, Dictionary<string, Style> styles) {
        ...
        protected new static Style ParseStyle(XmlNode styleNode) {
        ...
        protected new static Color ParseColor(string s) {
            if (s.StartsWith("#")) {
                if (s.Length <= 7)
        ...
        public new void HighlightSyntax(SyntaxDescriptor desc, Range range) {
            //set style order
        ...
        protected new void RestoreBrackets(FastColoredTextBox tb, char[] oldBrackets) {
        ...
        protected new char[] RememberBrackets(FastColoredTextBox tb) {
            return new[] { tb.LeftBracket, tb.RightBracket, tb.LeftBracket2, tb.RightBracket2 };
        }

        protected new void InitCShaprRegex() {
        ...
        public override void InitStyleSchema(Language lang) {
            switch (lang) {
                case Language.CSharp:
                ...
                case Language.XML:
                    CommentStyle = GreenStyle;
                    XmlTagBracketStyle = new TextStyle(new SolidBrush(Color.FromArgb(86, 156, 214)), null, FontStyle.Regular); ;
                    XmlTagNameStyle = new TextStyle(new SolidBrush(Color.FromArgb(86, 156, 214)), null, FontStyle.Regular); ;
                    XmlAttributeStyle = new TextStyle(new SolidBrush(Color.FromArgb(146, 202, 244)), null, FontStyle.Regular); ;
                    XmlAttributeValueStyle = new TextStyle(new SolidBrush(Color.FromArgb(200, 200, 200)), null, FontStyle.Regular); ;
                    XmlEntityStyle = new TextStyle(new SolidBrush(Color.FromArgb(200, 200, 200)), null, FontStyle.Regular); ;
                    XmlCDataStyle = new TextStyle(new SolidBrush(Color.FromArgb(233, 213, 133)), null, FontStyle.Regular);
                    break;
                case Language.JS:
                    StringStyle = BrownStyle;
                    CommentStyle = GreenStyle;
        ...
        public new virtual void CSharpSyntaxHighlight(Range range) {
...
";
        ...
        protected new void InitVBRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void VBSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = "'";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
...
";
        ...
        protected new void InitHTMLRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void HTMLSyntaxHighlight(Range range) {
        ...
        protected new void InitXMLRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void XMLSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = null;
            range.tb.LeftBracket = '<';
            range.tb.RightBracket = '>';
            range.tb.LeftBracket2 = '(';
        ...
        private new void XmlFolding(Range range) {
        ...
        protected new void InitSQLRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void SQLSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = "--";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
            range.tb.LeftBracket2 = '\x0';
        ...
        protected new void InitPHPRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void PHPSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = "//";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
            range.tb.LeftBracket2 = '{';
...
";
        ...
        protected new void InitJScriptRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void JScriptSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = "//";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
            range.tb.LeftBracket2 = '{';
...
";
        ...
        protected new void InitLuaRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void LuaSyntaxHighlight(Range range) {
            range.tb.CommentPrefix = "--";
            range.tb.LeftBracket = '(';
            range.tb.RightBracket = ')';
            range.tb.LeftBracket2 = '{';
...
";
        ...
        protected new void LuaAutoIndentNeeded(object sender, AutoIndentEventArgs args) {
            //end of block
        ...
        protected new void InitJSONRegex() {
        ...
        /// </summary>
        /// <param name="range"></param>
        public new virtual void JSONSyntaxHighlight(Range range) {
            range.tb.LeftBracket = '[';
            range.tb.RightBracket = ']';
            range.tb.LeftBracket2 = '{';
            range.tb.RightBracket2 = '}';
